<template>  
    <view class="container">  
		...
		<view class="user-section">
			<image class="bg" src="https://ec.yto.net.cn/api/file/file_9d9acc2c-2e9d-4a16-b7d4-1fd228eb3034"></image>
		...
		>
			...
			<view class="history-section icon">
				...
				<list-cell icon="icon-iconfontweixin" iconColor="#47086c" title="我的钱包" tips="您的会员还有3天过期"></list-cell>
				<list-cell icon="icon-dizhi" iconColor="#47086c" title="地址管理" @eventClick="navTo('/pages/address/address')"></list-cell>
				<list-cell icon="icon-share" iconColor="#47086c" title="分享" tips="邀请好友赢10万大礼"></list-cell>
				<list-cell icon="icon-pinglun-copy" iconColor="#47086c" title="晒单" tips="晒单抢红包"></list-cell>
				<list-cell icon="icon-shoucang_xuanzhongzhuangtai" iconColor="#47086c" title="我的收藏"></list-cell>
				<list-cell icon="icon-shezhi1" iconColor="#47086c" title="设置" border="" @eventClick="navTo('/pages/set/set')"></list-cell>
			</view>
		</view>
